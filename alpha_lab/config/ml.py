...
class MLSplitConfig:
    ...
    def __post_init__(self) -> None:
        # Basic temporal ordering check (if all are strings)
        # More rigorous validation should happen in the ML pipeline
        pass
...
def default_ml_model_config() -> MLModelConfig:
    """
    Return a reasonable default ML model config (RandomForest).
